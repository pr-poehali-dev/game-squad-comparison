...
UNITS = [
    ...
    {"id": "shadow-runners", "name": "Теневые Бегуны", "class": "Пехота", "role": "Борьба с кавалерией", "rarity": "uncommon",
    ...
    {"id": "storm-cavalry", "name": "Штормовая Кавалерия", "class": "Кавалерия", "role": "Танк", "rarity": "rare",
    ...
    {"id": "royal-longhorns", "name": "Королевские Длиннолучники", "class": "Стрелки", "role": "Борьба с кавалерией", "rarity": "rare",
    ...
    {"id": "siege-masters", "name": "Мастера Осады", "class": "Осадные", "role": "Танк", "rarity": "uncommon",
    ...
    {"id": "veil-mages", "name": "Маги Завесы", "class": "Магические", "role": "Борьба с кавалерией", "rarity": "epic",
    ...
    {"id": "death-whisperers", "name": "Шептуны Смерти", "class": "Магические", "role": "Борьба с кавалерией", "rarity": "legendary",
    ...
    {"id": "golden-crossbows", "name": "Золотые Арбалетчики", "class": "Стрелки", "role": "Борьба с кавалерией", "rarity": "uncommon",
    ...
    {"id": "highland-berserkers", "name": "Горные Берсерки", "class": "Пехота", "role": "Танк", "rarity": "rare",
